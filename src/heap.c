...
#ifdef NON_MATCHING
HeapChunk *mem_alloc(HeapChunk **arg0, s32 size) {
    HeapChunk *a0;
    HeapChunk *current;
    HeapChunk *next;
    HeapChunk *sp20;
...
#else
#pragma GLOBAL_ASM("asm/nonmatchings/heap/mem_alloc.s")
HeapChunk *mem_alloc(HeapChunk **arg0, s32 arg1);
#endif

void mem_free(HeapChunk *arg0) {
    HeapChunk *current;
    HeapChunk *previous;
